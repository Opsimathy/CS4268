...
\subsubsection{Unstructured Database Search Problem}
...
\section{Fundamental Axioms of Quantum Mechanics}
...
\subsubsection{Geometric Intuition (The Unit Circle)}
...
\subsection{Beyond 2 States: Qudits and General Laws}
...
\subsubsection{Example: The 4-dimensional system \texorpdfstring{($d=4$)}{(d=4)}}
